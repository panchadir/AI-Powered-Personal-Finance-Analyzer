...
6. **Persistent left nav** (Transactions / Dashboard / Insights / Copilot) present on all 4 app screens — FR-6.4 P0. Note: wireframes above are full-width; add a left-sidebar column (width ~200px) to every app-screen layout at implementation.
