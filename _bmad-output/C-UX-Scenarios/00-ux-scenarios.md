...
| 02 | [Priya Protects What Matters](02-priya-protects-what-matters/02-priya-protects-what-matters.md) | Priya (Primary) | 1 | 🚀 P2 | ✅ Outlined |
...
**Pages:** Register, Login (auto-authentication), Statement Upload, Transactions Table, Dashboard, AI Insights & Recommendations, Copilot Chat
...
| Statement Upload | 01.3 | 01 | Upload bank statement, watch honest parsing progress |
| Transactions Table | 01.4 | 01 | Review categorized transactions, correct one via "Teach Me" |
| Dashboard | 01.5 | 01 | See first Safe-to-Spend briefing + Confidence Score, explained |
...
**01.1 Register → 01.2 Login (auto) → 01.3 Statement Upload → 01.4 Transactions Table → 01.5 Dashboard → 01.6 AI Insights & Recommendations → 01.7 Copilot Chat**
...
- **Confidence Score Drill-in** remains deferred out of scope (removed at Step 2 by the project owner).
